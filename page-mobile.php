...
<body>
    ...
    <section class="application-main">
        ...
        <div class="mobile-download-icons">
            <a href="https://play.google.com/store/apps/details?id=com.agroup.agroup_mobile"> <img src="<?php templateDir() ?>/img/mobile-page/google_play.png" /> </a>
            <a href="https://apps.apple.com/az/app/a-group-mobile-concierge/id1601418581"> <img src="<?php templateDir() ?>/img/mobile-page/app_store.png" /> </a>
        </div>
    </section>
    <!-- END Header  -->
